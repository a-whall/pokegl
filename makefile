...
DEP_FILES := animation.h application.h camera.h collision.h colorstring.h debug.h frameid.h game.h map.h map_orientation.h mapid.h player.h scene.h shader.h sound.h soundid.h sprite.h text.h texture.h warps.h world.h
OBJ_FILES := animation.o application.o camera.o collision.o debug.o game.o main.o map.o player.o scene.o shader.o sound.o sprite.o text.o texture.o warps.o world.o
